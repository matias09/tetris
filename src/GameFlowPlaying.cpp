...
signed int GameFlowPlaying::Run(InputHandlerInterface& inpHandler
  ...
  do {
    ...
    if (_mThereIsBottomCollision == true) {
      ...
      if (_mThereIsLateralCollision == false) {
        _mBoard->EraseFigureInBoard(_mShape->GetMatrix()
                                  , _mPosFrom
                                  , _mShape->GetColumns()
                                  , _mShape->GetRows());

        _mBoard->UpdateFigureInBoard(_mShape->GetMatrix()
                                  , _mPosFrom
                                  , _mShape->GetColumns()
                                  , _mShape->GetRows());
        ...
        grpHandler.Render(_mBoard->GetBoardMatrix()
                        , _mBoard->GetColumns()
                        , _mBoard->GetRows()
                        , _mShape->GetRedVal()
                        , _mShape->GetGreenVal()
...
void GameFlowPlaying::_ExecuteShapeDown() { ++_mPosTo[Y_COORDINATE]; }
void GameFlowPlaying::_ExecuteShapeRight() { ++_mPosTo[X_COORDINATE]; }
void GameFlowPlaying::_ExecuteShapeLeft() { --_mPosTo[X_COORDINATE]; }
